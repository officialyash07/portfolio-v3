        ...
        <header className="w-full border-b border-(--border-color) bg-(--secondary-bg)">
            <div className="flex max-w-7xl items-center justify-between px-4 py-4 mx-auto">
                ...
                <nav className="hidden sm:flex items-center gap-8">
                    ...
                    <button className="flex h-9 w-9 items-center justify-center border-none">
                        <svg
                            width="800px"
                            height="800px"
                            viewBox="0 0 24 24"
            ...
            {/* Mobile Menu */}
            {isOpen && (
                <div className="sm:hidden border-t border-(--border-color) bg-(--secondary-bg)">
                    <nav className="flex flex-col gap-4 px-4 py-4">
                        ...
                        <button className="mt-2 flex h-9 w-9 items-center justify-center border-none">
                            <svg
                                width="800px"
                                height="800px"
                                viewBox="0 0 24 24"
